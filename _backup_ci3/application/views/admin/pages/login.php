    ...
    <body style="--bs-scrollbar-width: 0px;">
        <div class="authentication-wrapper authentication-cover">
            ...
            <a href="/" class="app-brand auth-cover-brand gap-2">
                ...
                <span class="app-brand-text demo text-heading fw-bold">PTI</span>
            </a>
            <!-- /Logo -->
            <div class="authentication-inner row m-0">
                ...
                <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
                    <div class="w-100 d-flex justify-content-center">
                        <img
                            src="/assets/images/boy-with-rocket-light.png"
                            class="img-fluid"
                            alt="Login image"
                            width="700"
                ...
                <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
                    <div class="w-px-400 mx-auto mt-sm-12 mt-8">
                        <p class="mb-6">Vui lòng đăng nhập vào tài khoản của bạn và bắt đầu cuộc phiêu lưu</p>
                        ...
                        <form action="" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary d-grid w-100" style="margin-top: 20px;">Đăng nhập</button>
                        </form>
                    </div>
                </div>
                <script>
