                    ...
                    <div class="d-md-flex justify-content-between align-items-center dt-layout-full table-responsive">
                        <table class="datatables-users table border-top dataTable dtr-column" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" style="width: 100%;">
                            ...
                            <?php foreach($datas as $data) {?>
                                ...
                                <?php } ?>
                                <td>
                                    <a href="/admin/opening-schedules?product_id=<?=$data['id']?>&address_id=1" class="btn btn-primary">Hà Nội</a>
                                    <a href="/admin/opening-schedules?product_id=<?=$data['id']?>&address_id=2" class="btn btn-primary" style="margin-top: 10px;">Hồ Chí Minh</a>
                                </td>
                                <td>
