...
class Order extends CI_Controller
{
    public function __construct() {
        parent::__construct();
        $this->load->model(['MOrder', 'MCategory', 'MProduct']);
        $this->load->database();
    ...
    public function index() {
        // is_admin();
        $data['title'] = "Danh sách yêu cầu đăng ký";
       
        $total = $this->MOrder->count_all(); // tổng số mục
        ...
        $order = $this->MOrder->get(['limit' => $perPage, 'offset' => $offset]);
        ...
        $data['content'] = '/admin/pages/orders/index';
    ...
    public function listField() {
        ...
        return [
            ...
            [
                ...
                'name' => 'Địa chỉ',
                'type' => 'option',
                'items' => $this->MProduct->getAddress()
            ],
            [
                'key' => 'note',
                'name' => 'Ghi chú',
