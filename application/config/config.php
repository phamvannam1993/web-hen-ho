...
|
*/
// Tự nhận diện base_url theo request để chạy đúng ở mọi cổng / thư mục con.
// Đặt biến môi trường APP_URL khi lên production nếu muốn cố định tên miền.
if (getenv('APP_URL')) {
...
|
*/
$config['encryption_key'] = getenv('APP_KEY') ?: 'henho24_dev_key_change_me_2026';
