...
(function () {
  ...
  CKEDITOR.editorConfig = function (config) {
    ...
    (config.filebrowserBrowseUrl =
      "/assets/ckeditor/ckfinder/ckfinder.php"),
      (config.filebrowserUploadUrl =
        "/assets/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files"),
      (config.filebrowserImageUploadUrl =
        "/assets/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images"),
      (config.filebrowserFlashUploadUrl =
        "/assets/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash"),
      // My Plugin
      /*/		
            config.plugins =
            // Plugin
      ...
      // Them Plugin
      (config.extraPlugins =
        "mdn-buttons,mdn-sampler,mdn-keystrokes,mdn-syntaxhighlighter,image2,quicktable,simpleuploads,accordion,doksoft_stat,doksoft_backup,doksoft_button,doksoft_youtube,doksoft_maps,doksoft_html");
    ...
    // File hop le
    config.simpleuploads_acceptedExtensions =
      "doc|docx|xls|xlsx|ppt|pdf|txt|rar|zip|jpeg|JPEG|jpg|gif|png|bmp";
